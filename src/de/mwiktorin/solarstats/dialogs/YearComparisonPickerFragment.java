...
public class YearComparisonPickerFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		((TextView) view.findViewById(R.id.two_years_picker_text)).setText(R.string.diagramm_fragment_dialog_pickyears_text_comparison);
